...
| Page | Path | Purpose |
|---|---|---|
| TV display | `/b/{boardId}` | fullscreen grid of live frames + big "Starte hier Dein kostenloses Inserat!" QR tile; polls feed every 20–30 s; vanilla HTML/CSS/JS; optimized for 55" at a few meters' viewing distance |
